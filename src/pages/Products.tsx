...
const Products = () => {
  ...
  const activeSubCategory = filters.subCategory !== "all"
    ...
    : null;
  const heroImage = (activeSubCategory?.image) || currentCollection?.heroImage || "https://qehygczsuthucpvtqndy.supabase.co/storage/v1/object/public/site-media/categories/hero-shop-all.jpg";
