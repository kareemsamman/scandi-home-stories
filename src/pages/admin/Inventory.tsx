...
const QtyRow = ({
  ...
  return (
    <div className={`flex items-center gap-3 px-4 py-2.5 ${isLow ? "bg-red-50/50" : ""}`}>
      {/* Size label */}
      ...
      <div className="flex items-center gap-1 flex-1">
        <button
          ...
          className="w-8 h-8 rounded-lg bg-gray-100 hover:bg-gray-200 active:bg-gray-300 flex items-center justify-center transition-colors touch-manipulation shrink-0"
        >
        ...
        <input
          ...
          className={`w-14 h-8 text-center text-sm font-bold rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-colors ${
            isLow ? "border-red-300 bg-red-50 text-red-700" : "border-gray-200 bg-white text-gray-900"
          }`}
        />
