...
export const translations: Record<Locale, Record<string, any>> = {
  he: {
    ...
    payment: {
      ...
      verifyingReceipt: 'בודק את הקובץ מול אימות AI...',
      verifyingReceiptDescription: 'הבדיקה עדיין מתבצעת. נא להמתין כמה שניות.',
      receiptDetected: 'נראה כי הקובץ מכיל אישור העברה.',
      receiptNotDetected: 'הקובץ אינו אישור העברה.',
      receiptNotDetectedDescription: 'יש להעלות רק אישור העברה בנקאית תקין כדי להמשיך.',
  ...
  ar: {
    ...
    payment: {
      ...
      verifyingReceipt: 'جارِ التحقق من الملف عبر AI...',
      verifyingReceiptDescription: 'التحقق ما زال جارياً. يرجى الانتظار بضع ثوانٍ.',
      receiptDetected: 'يبدو أن الملف يحتوي على إيصال تحويل.',
      receiptNotDetected: 'الملف ليس إيصال تحويل.',
      receiptNotDetectedDescription: 'يرجى رفع إيصال تحويل بنكي صحيح فقط للمتابعة.',
