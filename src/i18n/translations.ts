...
export const translations: Record<Locale, Record<string, any>> = {
  he: {
    ...
    cart: {
      ...
      freeShippingEligible: 'ההזמנה שלך זכאית למשלוח חינם',
      total: 'סה"כ',
      checkout: 'לתשלום',
    ...
    checkout: {
      ...
      invalidPhone: 'מספר טלפון חייב להכיל 10 ספרות',
  ...
  ar: {
    ...
    cart: {
      ...
      freeShippingEligible: 'طلبك مؤهل للشحن المجاني',
      total: 'الإجمالي',
    ...
    checkout: {
      ...
      invalidPhone: 'رقم الهاتف يجب أن يتكون من 10 أرقام',
