...
export const translations: Record<Locale, Record<string, any>> = {
  he: {
    ...
    pergolaRequest: {
      ...
      dimensions: 'מידות',
      width: 'רוחב (מ"מ)',
      length: 'עומק / הטלה (מ"מ)',
      height: 'גובה (מ"מ) - אופציונלי',
      configuration: 'תצורה',
      pergolaType: 'סוג פרגולה',
      pergolaTypes: {
        bioclimatic: 'ביוקלימטית',
        motorized: 'למלות מוטורית',
        fixed: 'קבועה',
        retractable: 'נפתחת',
      },
      mountType: 'סוג התקנה',
      ...
      installationYes: 'כן, אני צריך התקנה',
      lighting: 'תאורה',
      lightingNone: 'ללא',
      lightingWhite: 'לבנה',
      lightingRgb: 'RGB',
      ...
      backToHome: 'חזרה לדף הבית',
      disclaimer: 'השרטוט ופיזור העמודים הם ראשוניים ומותנים בבדיקה טכנית ובביקור באתר.',
      customReviewNote: 'הרוחב שהוזן דורש בדיקת התאמה מיוחדת. נציג ייצור איתכם קשר.',
      required: 'שדה חובה',
      invalidPhone: 'מספר טלפון לא תקין',
      minWidth: 'רוחב מינימלי 1000 מ"מ',
      maxWidth: 'רוחב מקסימלי 15000 מ"מ',
      minLength: 'עומק מינימלי 2000 מ"מ',
      maxLength: 'עומק מקסימלי 10000 מ"מ',
      yes: 'כן',
      no: 'לא',
    },
  },
  ar: {
    ...
    pergolaRequest: {
      ...
      dimensions: 'الأبعاد',
      width: 'العرض (مم)',
      length: 'العمق / الإسقاط (مم)',
      height: 'الارتفاع (مم) - اختياري',
      configuration: 'الإعدادات',
      pergolaType: 'نوع العرسية',
      pergolaTypes: {
        bioclimatic: 'بيوكليماتيك',
        motorized: 'لاميلا موتورية',
        fixed: 'ثابتة',
        retractable: 'قابلة للسحب',
      },
      mountType: 'نوع التركيب',
      mountWall: 'مثبتة على الحائط',
      mountFreestanding: 'مستقلة',
      installation: 'تركيب احترافي',
      installationYes: 'نعم، أحتاج تركيب',
      lighting: 'إضاءة',
      lightingNone: 'بدون',
      lightingWhite: 'أبيض',
      lightingRgb: 'RGB',
      ...
      backToHome: 'العودة للرئيسية',
      disclaimer: 'الرسم التخطيطي وتوزيع الأعمدة أولية وتخضع للفحص الفني وزيارة الموقع.',
      customReviewNote: 'العرض المدخل يتطلب مراجعة خاصة. سيتواصل معك أحد ممثلينا.',
      required: 'حقل مطلوب',
      invalidPhone: 'رقم هاتف غير صالح',
      minWidth: 'الحد الأدنى للعرض 1000 مم',
      maxWidth: 'الحد الأقصى للعرض 15000 مم',
      minLength: 'الحد الأدنى للعمق 2000 مم',
      maxLength: 'الحد الأقصى للعمق 10000 مم',
      yes: 'نعم',
      no: 'لا',
    },
    notFound: {
