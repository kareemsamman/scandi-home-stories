          ...
          >
            ...
            >
              ...
              <div className="px-6 pb-6">
                ...
                {/* No default / clear */}
                <button
                  onClick={() => { clearColor(); setOpen(false); }}
                  className="w-full mt-4 py-2.5 rounded-xl border-2 border-dashed border-gray-200 hover:border-gray-400 text-sm font-medium text-gray-500 hover:text-gray-700 transition-all"
                >
                  {isAr ? "بدون لون افتراضي — سأختار لكل منتج" : "ללא ברירת מחדל — אבחר לכל מוצר בנפרד"}
                </button>
              </div>
            </motion.div>
          </motion.div>
