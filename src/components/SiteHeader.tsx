        ...
        <div className="px-6 md:px-10">
          ...
          <div className="hidden md:grid grid-cols-3 items-center h-24">
            ...
            <div className="flex items-center justify-end gap-1">
              ...
              <Link to={localePath("/cart")} className="relative p-2 text-white/70 hover:text-white transition-colors" aria-label="Cart">
                ...
                <AnimatePresence>
                  {itemCount > 0 && (
                    <motion.span initial={{ scale: 0 }} animate={{ scale: 1 }} exit={{ scale: 0 }} className="absolute -top-0.5 -end-0.5 w-4 h-4 bg-white text-dark text-[10px] font-bold rounded-full flex items-center justify-center">
          ...
          <div className="flex md:hidden items-center justify-between h-14">
            <div className="flex items-center gap-0.5">
              <button className="p-2 text-white/80 hover:text-white transition-colors" onClick={() => setMobileOpen(true)} aria-label="Menu">
                <MenuIcon />
              </button>
            ...
            <div className="flex items-center gap-0.5">
              <button className="p-2 text-white/80 hover:text-white transition-colors" aria-label="Account">
                <AccountIcon />
              </button>
              <Link to={localePath("/cart")} className="relative p-2 text-white/80 hover:text-white transition-colors" aria-label="Cart">
                <CartIcon />
                <AnimatePresence>
                  {itemCount > 0 && (
                    <motion.span initial={{ scale: 0 }} animate={{ scale: 1 }} exit={{ scale: 0 }} className="absolute -top-0.5 -end-0.5 w-4 h-4 bg-white text-dark text-[10px] font-bold rounded-full flex items-center justify-center">
